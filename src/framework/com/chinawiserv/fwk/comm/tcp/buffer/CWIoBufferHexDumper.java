...
/**
 * Provides utility methods to dump an {@link CWIoBuffer} into a hex formatted string.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
class CWIoBufferHexDumper {
    ...
    /**
     * Dumps an {@link CWIoBuffer} to a hex formatted string.
     * 
     ...
     */
    public static String getHexdump(CWIoBuffer in, int lengthLimit) {
        if (lengthLimit == 0) {

...
/**
 * Allocates {@link CWIoBuffer}s and manages them.  Please implement this
 * interface if you need more advanced memory management scheme.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public interface CWIoBufferAllocator {
    /**
     ...
     */
    CWIoBuffer allocate(int capacity, boolean direct);
     ...
     */
    CWIoBuffer wrap(ByteBuffer nioBuffer);

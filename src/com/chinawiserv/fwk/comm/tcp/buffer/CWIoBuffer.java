 ...
 * easy, and it is because its size is fixed. {@link CWIoBuffer} introduces
 ...
 * </pre>
 * 
 * The underlying {@link ByteBuffer} is reallocated by {@link CWIoBuffer} behind
 ...
 * allocated memory area is not being used. {@link CWIoBuffer} provides
 * <tt>autoShrink</tt> property to take care of this issue. If
 * <tt>autoShrink</tt> is turned on, {@link CWIoBuffer} halves the capacity of the
 ...
 * <p>
 * {@link CWIoBufferAllocator} interface lets you override the default buffer
 * management behavior. There are two allocators provided out-of-the-box:
 * <ul>
 * <li>{@link CWSimpleBufferAllocator} (default)</li>
 * <li>{@link CachedBufferAllocator}</li>
 * </ul>
 * You can implement your own allocator and use it by calling
 * {@link #setAllocator(CWIoBufferAllocator)}.
 * </p>
 * 
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public abstract class CWIoBuffer implements Comparable<CWIoBuffer> {
    /** The allocator used to create new buffers */
    private static CWIoBufferAllocator allocator = new CWSimpleBufferAllocator();
     ...
     */
    public static CWIoBufferAllocator getAllocator() {
        return allocator;
    }
     ...
     */
    public static void setAllocator(CWIoBufferAllocator newAllocator) {
        if (newAllocator == null) {
            throw new IllegalArgumentException("allocator");
        }

        CWIoBufferAllocator oldAllocator = allocator;
    ...
    public static void setUseDirectBuffer(boolean useDirectBuffer) {
        CWIoBuffer.useDirectBuffer = useDirectBuffer;
    }
     ...
     */
    public static CWIoBuffer allocate(int capacity) {
     ...
     *            heap buffer.
     */
    public static CWIoBuffer allocate(int capacity, boolean direct) {
        if (capacity < 0) {
     ...
     */
    public static CWIoBuffer wrap(ByteBuffer nioBuffer) {
     ...
     */
    public static CWIoBuffer wrap(byte[] byteArray) {
     ...
     * Wraps the specified byte array into MINA heap buffer.
     */
    public static CWIoBuffer wrap(byte[] byteArray, int offset, int length) {
     ...
     */
    protected CWIoBuffer() {
        // Do nothing
    }

    /**
     * Declares this buffer and all its derived buffers are not used anymore so
     * that it can be reused by some {@link CWIoBufferAllocator} implementations.
     ...
     * the buffer.
     */
    public abstract CWIoBuffer minimumCapacity(int minimumCapacity);
     ...
     * the buffer.
     */
    public abstract CWIoBuffer capacity(int newCapacity);
     ...
     */
    public abstract CWIoBuffer setAutoExpand(boolean autoExpand);
     ...
     */
    public abstract CWIoBuffer setAutoShrink(boolean autoShrink);
     ...
     */
    public abstract CWIoBuffer expand(int expectedRemaining);
     ...
     */
    public abstract CWIoBuffer expand(int position, int expectedRemaining);
     ...
     */
    public abstract CWIoBuffer shrink();
     ...
     */
    public abstract CWIoBuffer position(int newPosition);
     ...
     */
    public abstract CWIoBuffer limit(int newLimit);

    /**
     * @see java.nio.Buffer#mark()
     */
    public abstract CWIoBuffer mark();
     ...
     */
    public abstract CWIoBuffer reset();

    /**
     * @see java.nio.Buffer#clear()
     */
    public abstract CWIoBuffer clear();
     ...
     * discarded.
     */
    public abstract CWIoBuffer sweep();
     ...
     * is discarded.
     */
    public abstract CWIoBuffer sweep(byte value);

    /**
     * @see java.nio.Buffer#flip()
     */
    public abstract CWIoBuffer flip();

    /**
     * @see java.nio.Buffer#rewind()
     */
    public abstract CWIoBuffer rewind();
     ...
     */
    public abstract CWIoBuffer duplicate();

    /**
     * @see ByteBuffer#slice()
     */
    public abstract CWIoBuffer slice();

    /**
     * @see ByteBuffer#asReadOnlyBuffer()
     */
    public abstract CWIoBuffer asReadOnlyBuffer();
     ...
     */
    public abstract CWIoBuffer put(byte b);
     ...
     */
    public abstract CWIoBuffer put(int index, byte b);

    /**
     * @see ByteBuffer#get(byte[], int, int)
     */
    public abstract CWIoBuffer get(byte[] dst, int offset, int length);

    /**
     * @see ByteBuffer#get(byte[])
     */
    public abstract CWIoBuffer get(byte[] dst);

    /**
     * TODO document me.
     */
    public abstract CWIoBuffer getSlice(int index, int length);

    /**
     * TODO document me.
     */
    public abstract CWIoBuffer getSlice(int length);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract CWIoBuffer put(ByteBuffer src);

    /**
     * Writes the content of the specified <tt>src</tt> into this buffer.
     */
    public abstract CWIoBuffer put(CWIoBuffer src);

    /**
     * @see ByteBuffer#put(byte[], int, int)
     */
    public abstract CWIoBuffer put(byte[] src, int offset, int length);

    /**
     * @see ByteBuffer#put(byte[])
     */
    public abstract CWIoBuffer put(byte[] src);

    /**
     * @see ByteBuffer#compact()
     */
    public abstract CWIoBuffer compact();
     ...
     */
    public abstract CWIoBuffer order(ByteOrder bo);
     ...
     */
    public abstract CWIoBuffer putChar(char value);
     ...
     */
    public abstract CWIoBuffer putChar(int index, char value);
     ...
     */
    public abstract CWIoBuffer putShort(short value);
     ...
     */
    public abstract CWIoBuffer putShort(int index, short value);
     ...
     */
    public abstract CWIoBuffer putMediumInt(int value);
     ...
     *             If this buffer is read-only
     */
    public abstract CWIoBuffer putMediumInt(int index, int value);

    /**
     * @see ByteBuffer#putInt(int)
     */
    public abstract CWIoBuffer putInt(int value);

    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsigned(byte value);
     ...
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsigned(int index, byte value);

    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsigned(short value);
     ...
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsigned(int index, short value);

    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsigned(int value);
     ...
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsigned(int index, int value);

    /**
     * Writes an unsigned byte into the ByteBuffer
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsigned(long value);
     ...
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsigned(int index, long value);

    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsignedInt(byte value);
     ...
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsignedInt(int index, byte value);

    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsignedInt(short value);
     ...
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsignedInt(int index, short value);

    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsignedInt(int value);
     ...
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsignedInt(int index, int value);

    /**
     * Writes an unsigned int into the ByteBuffer
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsignedInt(long value);
     ...
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsignedInt(int index, long value);

    /**
     * Writes an unsigned short into the ByteBuffer
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsignedShort(byte value);
     ...
     * @param value the byte to write
     */
    public abstract CWIoBuffer putUnsignedShort(int index, byte value);

    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsignedShort(short value);
     ...
     * @param value the short to write
     */
    public abstract CWIoBuffer putUnsignedShort(int index, short value);

    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsignedShort(int value);
     ...
     * @param value the int to write
     */
    public abstract CWIoBuffer putUnsignedShort(int index, int value);

    /**
     * Writes an unsigned Short into the ByteBuffer
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsignedShort(long value);
     ...
     * @param value the long to write
     */
    public abstract CWIoBuffer putUnsignedShort(int index, long value);
     ...
     */
    public abstract CWIoBuffer putInt(int index, int value);
     ...
     */
    public abstract CWIoBuffer putLong(long value);
     ...
     * @see ByteBuffer#putLong(int, long)
     */
    public abstract CWIoBuffer putLong(int index, long value);
     ...
     */
    public abstract CWIoBuffer putFloat(float value);
     ...
     */
    public abstract CWIoBuffer putFloat(int index, float value);
     ...
     */
    public abstract CWIoBuffer putDouble(double value);
     ...
     */
    public abstract CWIoBuffer putDouble(int index, double value);
     ...
     */
    public abstract CWIoBuffer putString(CharSequence val, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     */
    public abstract CWIoBuffer putString(CharSequence val, int fieldSize, CharsetEncoder encoder)
     ...
     *             if the specified string doesn't fit
     */
    public abstract CWIoBuffer putPrefixedString(CharSequence in, CharsetEncoder encoder) throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract CWIoBuffer putPrefixedString(CharSequence in, int prefixLength, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract CWIoBuffer putPrefixedString(CharSequence in, int prefixLength, int padding, CharsetEncoder encoder)
            throws CharacterCodingException;
     ...
     *             if the specified string doesn't fit
     */
    public abstract CWIoBuffer putPrefixedString(CharSequence val, int prefixLength, int padding, byte padValue,
     ...
     */
    public abstract CWIoBuffer putObject(Object o);
     ...
     */
    public abstract CWIoBuffer putEnum(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract CWIoBuffer putEnum(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract CWIoBuffer putEnumShort(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract CWIoBuffer putEnumShort(int index, Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract CWIoBuffer putEnumInt(Enum<?> e);
     ...
     *            The enum to write to the buffer
     */
    public abstract CWIoBuffer putEnumInt(int index, Enum<?> e);
     ...
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSet(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSet(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetShort(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetShort(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetInt(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetInt(int index, Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetLong(Set<E> set);
     ...
     *            the enum set to write to the buffer
     */
    public abstract <E extends Enum<E>> CWIoBuffer putEnumSetLong(int index, Set<E> set);
}
